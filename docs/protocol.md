        # Clauderepo: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/clauderepo.git

        ## Objective

        ClaudeRepo is a repository of AI-assisted clinical evidence synthesis workflows, providing reusable pipelines and templates for meta-analytic research.
        ...
        - Code: https://github.com/mahmood726-cyber/clauderepo.git
        - Dashboard: N/A
